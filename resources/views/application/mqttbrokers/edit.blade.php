            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h6 class="mb-0">Edit MQTT Broker: {{ $mqttbroker->name }}</h6>
                    </div>
                        ...
                        <form action="{{ route('app.mqttbrokers.update', $mqttbroker) }}" method="POST">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                        ...
                                        <option value="mosquitto" {{ old('type', $mqttbroker->type) == 'mosquitto' ? 'selected' : '' }}>Mosquitto</option>
                                        <option value="emqx" {{ old('type', $mqttbroker->type) == 'emqx' ? 'selected' : '' }}>EMQX</option>
                                        <option value="lorawan" {{ old('type', $mqttbroker->type) == 'lorawan' ? 'selected' : '' }}>LoRaWAN</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    Update MQTT Broker <i class="ph-floppy-disk ms-2"></i>
                                </button>
                            </div>
                        </form>
                    </div>
