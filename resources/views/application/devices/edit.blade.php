                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="protocol" class="form-select @error('protocol') is-invalid @enderror" required>
                                        ...
                                        <option value="mqtt" {{ old('protocol', $device->protocol) == 'mqtt' ? 'selected' : '' }}>MQTT</option>
                                        <option value="mqtts" {{ old('protocol', $device->protocol) == 'mqtts' ? 'selected' : '' }}>MQTT over SSL/TLS</option>
                                        <option value="ws" {{ old('protocol', $device->protocol) == 'ws' ? 'selected' : '' }}>WebSocket</option>
                                        <option value="wss" {{ old('protocol', $device->protocol) == 'wss' ? 'selected' : '' }}>WebSocket Secure</option>
                                    </select>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" name="mqtt_port" class="form-control @error('mqtt_port') is-invalid @enderror" 
                                           placeholder="1883" value="{{ old('mqtt_port', $device->mqtt_port ?? 1883) }}" min="1" max="65535">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" name="mqtts_port" class="form-control @error('mqtts_port') is-invalid @enderror" 
                                           placeholder="8883" value="{{ old('mqtts_port', $device->mqtts_port ?? 8883) }}" min="1" max="65535">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" name="ws_port" class="form-control @error('ws_port') is-invalid @enderror" 
                                           placeholder="8083" value="{{ old('ws_port', $device->ws_port ?? 8083) }}" min="1" max="65535">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" name="wss_port" class="form-control @error('wss_port') is-invalid @enderror" 
                                           placeholder="8084" value="{{ old('wss_port', $device->wss_port ?? 8084) }}" min="1" max="65535">
