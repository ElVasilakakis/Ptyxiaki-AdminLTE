...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('notifications', function (Blueprint $table) {
            ...
            $table->string('type'); // 'threshold_exceeded', 'device_offline', 'geofence_violation', etc.
            $table->string('title');
            $table->text('message');
            $table->json('data')->nullable(); // Additional data like threshold values, coordinates, etc.
